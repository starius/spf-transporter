...
func applyMinerPayouts(tx *bolt.Tx, pb *processedBlockV2) {
...
// node diff set.
func applyMaturedSiacoinOutputs(tx *bolt.Tx, pb *processedBlockV2) {
...
// contract expiring.
func applyMissedStorageProof(tx *bolt.Tx, pb *processedBlockV2, fcid types.FileContractID) (dscods []modules.DelayedSiacoinOutputDiff, fcd modules.FileContractDiff) {
	// Sanity checks.
...
func applyFileContractMaintenance(tx *bolt.Tx, pb *processedBlockV2) {
...
// applied.
func applyMaintenance(tx *bolt.Tx, pb *processedBlockV2) {
